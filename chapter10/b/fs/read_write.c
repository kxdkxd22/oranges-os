...
/*	printl("hello do_rdwt\n");*/
	...
	if (imode == I_CHAR_SPECIAL) {
		...
		int i;
		/*printf("hello rea_write.c\n");*/
		printl("rw_sect_min:%d rw_sect_max:%d chunk:%d bytes_left:%d off:%d\n",rw_sect_min,rw_sect_max,chunk,bytes_left,off);
